...
import { CUISINE } from '../../src/content/practical/cuisine'
...
export default function Cuisine() {
  ...
  return (
    <View style={s.wrap}>
      <ScreenHeader title={t('modCuisine')} subtitle={t('modCuisineSub')} />
      <ScrollView contentContainerStyle={s.list}>
        {CUISINE.map((it, i) => (
          <View key={i} style={s.card}>
            <View style={s.iconWrap}><Ionicons name={it.icon as any} size={22} color={colors.gold} /></View>
            <View style={s.text}>
...
const s = StyleSheet.create({
  ...
  iconWrap: { width: 44, height: 44, borderRadius: radius.md, borderWidth: 1.5, borderColor: colors.gold, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceAlt },
  text: { flex: 1 },
